...
print mess
print "Created by Tcnopdtor"
title = raw_input("Name/Title: ")
heading = raw_input("Hacked by: ")
imagelink = raw_input("image link (center): ")
bgimage = raw_input("image link (background): ")
message = raw_input("Message. use <br> code for the next text! : ")
...
messagescript15 = """&autoplay=1" frameborder="0"></iframe>"""
...
print "Subscribe : Techno Predictor "
